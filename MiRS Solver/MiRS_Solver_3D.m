...
field_size_z = 1;                       % Maximum separation in altitude between nodes
offset_z = 100;                         % Height of master node above slave nodes
error_var_r = 0.0025;                   % Standard deviation of range measurements
...
% Calculate number of equations and number of unknowns
...
for n = 1:length(baseDistance)
    ...
    % Calculate gain at target point
    ...
    % Calculate error in focus point position
...
% Loop across points to calculate gain at each location
